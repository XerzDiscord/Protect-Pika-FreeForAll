...
module.exports.run = async(client, message, args) => {
  ...
  //  if (member.roles.has(muteRole)) return message.channel.send(`${config.emoji.error} \`ERROR\` Ce membre est déjà réduit au silence !`)
    ...
    .setDescription(`${message.author} a réduit au silence ${member.user.tag} pour la raison : \n \`${reason}\``)
    ...
    module.exports.help = {
        name: 'mute',
        category: 'mods',
        description: 'Reduit au silence un membre',
        aliases: ["silence"],
        usage: "<user>",
        args: true,
        guildOnly: true
